...
<body>
               ...
               <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Company Profile
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <form role="form">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="email" id="emailField" type="text" placeholder="Email" disabled>
                                </div>


                                <div class="form-group">
                                    <label for="disabledSelect">Name</label>
                                    <input class="form-control" name="name" id="nameField" type="text" placeholder="Name" disabled>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="contact" id="contactField" type="text" placeholder="Phone" disabled>
                                </div>


                                <div class="form-group">
                                    <label for="disabledSelect">Address</label>
                                    <input class="form-control" name="address" id="addressField" type="text" placeholder="Address" disabled>
                                </div>
                     ...
                     <div class="col-lg-3" style="margin-top:170px;">
                        ...
                        <button class="btn btn-primary" id="savename" onclick="return editName();">SAVE</button><br><br><br>    
   ...
   <script language="javascript" src="js/ajaxProfile.js"></script>
    ...
    <script type="text/javascript">
                                ...
                                function initialDisplay()
                                {
                                    ...
                                    console.log(email);
                                    console.log('inside initial diplay');
